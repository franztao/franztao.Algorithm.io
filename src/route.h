...
extern bool reverseDFS_mustedgeoutnode(Graph *p_graph, Request *p_request,vector<int> &permute);


extern bool LoadGraphData(Graph *graph, char *topo[MAX_EDGE_NUM], int edgenum,
...
extern bool findAP_interval_dijastra(Graph *p_graph, Request *p_request,vector<int> &permute);

extern bool findBP(Graph *p_graph, Request *p_request);

extern bool ILPAlgorithm_gurobi(Graph *graph,int type);
extern bool ILPAlgorithm_glpk(Graph *graph);
extern bool ILPAlgorithmBasicFlows_LocalSolver(Graph *graph);
extern bool IPAlgorithmBasicFlows(Graph *p_graph,int type);
extern bool IQPAlgorithm_gurobi(Graph *p_graph,int type);

extern bool IHKSPAlgorithm(Graph *p_graph);
extern bool KSPAlgorithmBasicFlows(Graph *p_graph);

extern bool CoSE_findAP_ILP_gurobi(Graph *p_graph, Request *p_request);
extern bool CoSE_findAP_dijastra(Graph *p_graph, Request *p_request);
extern bool CoSEAlgorithmBasicFlows(Graph *p_graph);
extern bool CoSEfindBP(Graph *p_graph, Request *p_request);
#endif
