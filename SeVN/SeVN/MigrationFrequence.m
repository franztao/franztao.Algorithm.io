...
dataVectorVN=[];
for i=1:1:AlgNum
    dataEVN=load([FileAbsolutePath,'Data\\MigrationFrequence_node',strtrim(AlgName(i,:)),'.txt']);
    dataVN=load([FileAbsolutePath,'Data\\MigrationFrequence_edge',strtrim(AlgName(i,:)),'.txt']);
