...
dataVectorEdgeUsed=[];
for i=1:1:AlgNum
    dataNodeUsed=load([FileAbsolutePath,'Data\\Utilization_VirNode_',strtrim(AlgName(i,:)),'.txt']);
    dataEdgeUsed=load([FileAbsolutePath,'Data\\Utilization_VirEdge_',strtrim(AlgName(i,:)),'.txt']);
    
    dataNode=load([FileAbsolutePath,'Data\\Revenue_NodeCp_',strtrim(AlgName(i,:)),'.txt']);
    dataEdge=load([FileAbsolutePath,'Data\\Revenue_EdgeBw_',strtrim(AlgName(i,:)),'.txt']);
...
title('VirtualNewtork Current Utilization');
...
saveas(gcf,[FileAbsolutePath,'Data\\Fig','\\UtilizationCurrentVirtualNetwork','.eps']);
saveas(gcf,[FileAbsolutePath,'Data\\Fig','\\UtilizationCurrentVirtualNetwork','.jpg']);
