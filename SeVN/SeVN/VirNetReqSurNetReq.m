...
dataVectorEdgeUsed=[];
for i=1:1:AlgNum
    dataNodeUsed=load([FileAbsolutePath,'Data\\Request_VirNet_',strtrim(AlgName(i,:)),'.txt']);
    dataEdgeUsed=load([FileAbsolutePath,'Data\\Request_SurNet_',strtrim(AlgName(i,:)),'.txt']);
    
    dataNode=load([FileAbsolutePath,'Data\\Request_VirNet_Accumulate_',strtrim(AlgName(i,:)),'.txt']);
    dataEdge=load([FileAbsolutePath,'Data\\Request_SurNet_Accumulate_',strtrim(AlgName(i,:)),'.txt']);
