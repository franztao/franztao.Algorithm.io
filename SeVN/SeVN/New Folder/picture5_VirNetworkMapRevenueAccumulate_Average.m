...
for i=1:1:AlgNum
    ...
    alg=load([FileAbsolutePath,'Data\\MapRevenue_virnet_Sum_',strtrim(AlgName(i,:)),'.txt']);
    Average=[Average;alg'];
...
saveas(gcf,[FileAbsolutePath,'Data\\Fig','\\VirtualNewtorkAccumulateStress','.eps']);
saveas(gcf,[FileAbsolutePath,'Data\\Fig','\\VirtualNewtorkAccumulateStress','.jpg']);
