...
Average=[];
for i=1:1:AlgNum
    dataNodeUsed=load([FileAbsolutePath,'Data\\MapCost_usedNode_',strtrim(AlgName(i,:)),'.txt']);
    dataEdgeUsed=load([FileAbsolutePath,'Data\\MapCost_usedEdge_',strtrim(AlgName(i,:)),'.txt']);
    
    dataNode=load([FileAbsolutePath,'Data\\MapCost_nodeCp_',strtrim(AlgName(i,:)),'.txt']);
    dataEdge=load([FileAbsolutePath,'Data\\MapCost_edgeBw_',strtrim(AlgName(i,:)),'.txt']);
    ...
    alg=load([FileAbsolutePath,'Data\\MapRevenue_subnet_',strtrim(AlgName(i,:)),'.txt']);
    Average=[Average;alg']
...
saveas(gcf,[FileAbsolutePath,'Data\\Fig','\\SubstrateNewtorkCurrentStress','.eps']);
saveas(gcf,[FileAbsolutePath,'Data\\Fig','\\SubstrateNewtorkCurrentStress','.jpg']);
