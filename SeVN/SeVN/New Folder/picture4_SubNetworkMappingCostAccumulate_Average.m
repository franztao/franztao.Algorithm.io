...
for i=1:1:AlgNum
    dataNodeUsed=load([FileAbsolutePath,'Data\\MapCost_usedNode_Sum_',strtrim(AlgName(i,:)),'.txt']);
    dataEdgeUsed=load([FileAbsolutePath,'Data\\MapCost_usedEdge_Sum_',strtrim(AlgName(i,:)),'.txt']);
    
    dataNode=load([FileAbsolutePath,'Data\\MapCost_nodeCp_Sum_',strtrim(AlgName(i,:)),'.txt']);
    dataEdge=load([FileAbsolutePath,'Data\\MapCost_edgeBw_Sum_',strtrim(AlgName(i,:)),'.txt']);
    ...
    alg=load([FileAbsolutePath,'Data\\MapRevenue_subnet_Sum_',strtrim(AlgName(i,:)),'.txt']);
    Average=[Average;alg'];
...
title('SubstrateNewtork Accumulate Stress');
...
saveas(gcf,[FileAbsolutePath,'Data\\Fig','\\SubstrateNewtorkAccumulateStress','.eps']);
saveas(gcf,[FileAbsolutePath,'Data\\Fig','\\SubstrateNewtorkAccumulateStress','.jpg']);
