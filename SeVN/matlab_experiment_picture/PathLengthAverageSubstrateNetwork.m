...
title('PathLengthAverageSubstrateNetwork');
hold on;
grid on;
axis tight
for i=1:1:AlgNum
...
saveas(gcf,[FileAbsolutePath,'Data\\Fig','\\PathLengthAverageSubstrateNetwork','.eps']);
saveas(gcf,[FileAbsolutePath,'Data\\Fig','\\PathLengthAverageSubstrateNetwork','.jpg']);
