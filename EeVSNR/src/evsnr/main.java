...
//		FDSubstrateNework.startExperiment(vnp);
		...
		// EnhancedVirtualNetwork EVNR1 = new EnhancedVirtualNetwork(7, 4, 4,
		// VNR1);
		// EVNR1.initSample1();
		// EVNR1.computeItems();
		...
		// System.out.println("------------------" + "----------------");
		//
		// EnhancedVirtualNetwork EVNR2 = new EnhancedVirtualNetwork(7, 4, 4,
		// VNR1);
		// EVNR2.initSample1();
		// EVNR2.computeItems();
		...
		// VNR2.initSample2();
		//
		// EnhancedVirtualNetwork EVNR3 = new EnhancedVirtualNetwork(4, 2, 2,
		// VNR2);
		// EVNR3.initSample2();
		// EVNR3.computeItems();
		...
		// VNR3.initSample3();
		// EnhancedVirtualNetwork EVNR5 = new EnhancedVirtualNetwork(2, 0, 2,
		// VNR3);
		// EVNR5.initSample3();
		// EVNR5.computeItems();
