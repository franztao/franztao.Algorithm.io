...
for i=1:4
    subplot(2,2,i);
    url=strcat(abusolutepath,str_test_sort_array(i),'\\Space size of filters.txt');
...
% imwrite(savesfig.cdata,strcat('F:\\Paper\\BloomFilter\\SFBF-submitted to TDKE20161208\\franztao20161209\\','p3_SpaceSizeFilters.jpg'))
...
print(gcf, '-depsc2',['F:\\Paper\\BloomFilter\\SFBF-submitted to TDKE20161208\\franztao20161209','\\p3_SpaceSizeFilters','.eps']);
% saveas(gcf,['F:\\Paper\\BloomFilter\\SFBF-submitted to TDKE20161208\\franztao20161209','\\p3_SpaceSizeFilters','.eps']);
% saveas(gcf,['F:\\Paper\\BloomFilter\\SFBF-submitted to TDKE20161208\\franztao20161209','\\p3_SpaceSizeFilters','.jpg']);
